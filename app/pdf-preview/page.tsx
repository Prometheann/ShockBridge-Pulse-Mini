    ...
    <>
      ...
      <div className="page">
        ...
        <div className="content" style={{paddingTop:"16mm"}}>
          ...
          <p className="summary">The real danger here is not the earnings miss itself — it is the timing. NVIDIA's valuation has been functioning as a single-stock proxy for the entire AI capex supercycle narrative, and a shortfall against consensus hits that narrative precisely when Middle East escalation is already compressing risk appetite and raising the cost of capital for long-duration growth assets.</p>
        </div>
