    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Closing text */
        .closing { text-align: center; font-size: 9pt; font-weight: 400; color: #64748b; letter-spacing: 0.08em; padding-top: 16px; border-top: 1px solid #1e293b; position: absolute; left: 24mm; right: 24mm; bottom: 14mm; }
        /* Cover */
